...
This is difficult to tell. They are APPROXIMATELY equal, and considering this is from sampled data, and we know that arithmetically the two numbers should be the same (.36 and .36, as shown in 2E), we can say that it is *probably* (not a technical term!) equal. By this logic and this set of assumptions, we can say that **NO, they are probably not independent** given these conditions.
